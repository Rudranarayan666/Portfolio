...
const stackCategories = [
  {
    ...
    icon: Code2,
    badgeBg: 'bg-[#fde047]',
    pills: ['Python', 'DSA', 'Java', '.NET & C#', 'OOP', 'SQL & Databases', 'Git & GitHub', 'Linux', 'Operating Systems', 'Computer Networks']
  },
  {
    title: 'AI / Machine Learning & Data',
    icon: Cpu,
    badgeBg: 'bg-[#86efac]',
    pills: ['PyTorch', 'Scikit-Learn', 'DuckDB', 'Pandas & NumPy', 'LangGraph', 'Agentic AI & MCP', 'XAI / SHAP', 'OpenCV', 'Generative AI', 'Vector DBs', 'Claude Code']
  },
  {
    title: 'Full-Stack Development',
    icon: Server,
    badgeBg: 'bg-[#7dd3fc]',
    pills: ['React.js', 'Next.js', 'FastAPI', 'Node.js & Express', 'MongoDB', 'MySQL', 'RESTful APIs', 'Authentication (JWT)', 'HTML5 & Tailwind CSS']
  },
  {
          ...
          {stackCategories.map((cat, idx) => {
            ...
            return (
              ...
              >
                ...
                {/* Tactile Stickers with mobile wrapping */}
                <div className="flex flex-wrap gap-1.5 sm:gap-2 pt-0.5">
                  {cat.pills.map((pill, pillIdx) => (
                    <span
                      key={pillIdx}
                      className="px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-lg bg-zinc-50 hover:bg-[#fde047] border-2 border-black font-mono text-[11px] sm:text-xs font-bold text-black shadow-[1.5px_1.5px_0px_0px_#000] sm:shadow-[2px_2px_0px_0px_#000] active:translate-x-0.5 active:translate-y-0.5 transition-all cursor-default select-none"
                    >
                      {pill}
                    </span>
                  ))}
