...
export default function Certificates() {
  return (
    <section id="certifications" className="py-16 relative scroll-mt-20">
              ...
              >
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <span className={`font-mono text-xs font-bold px-2.5 py-0.5 rounded border border-black shadow-[2px_2px_0px_0px_#000] ${issuerBg} text-black`}>
                      {cert.issuer}
                    </span>
                ...
                <div className="pt-3 border-t-2 border-zinc-100">
                  <a
                    ...
                    className="neo-btn neo-btn-secondary w-full py-2 text-xs font-mono"
                  >
